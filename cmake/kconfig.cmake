	...
	foreach(NameAndValue ${ConfigContents})
		...
		if(Modules)
			...
			string(TOLOWER ${module} module)
                       ...
                       string(REGEX REPLACE "_([^_]+)$" "" module_folder ${module})
			...
			elseif(EXISTS ${PX4_SOURCE_DIR}/src/modules/${module_p1_folder}/${module_p1_subfolder})
				list(APPEND config_module_list modules/${module_p1_folder}/${module_p1_subfolder})
                       ...
                       elseif(EXISTS ${PX4_SOURCE_DIR}/src/modules/${module_folder})
                               list(FIND config_module_list modules/${module_folder} module_idx)
                               if(module_idx EQUAL -1)
                                       list(APPEND config_module_list modules/${module_folder})
                               endif()
                       else()
